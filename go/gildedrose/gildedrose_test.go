...
func (t *gdSuite) TestOther() {
	...
	testCase := []struct {
		...
		{
			Desc:         "Case 6 Other sellIn 20 quality 10",
			numberOfDays: 6,
			items: []*gildedrose.Item{
				{"Other", 20, 10},
			},
...
func (t *gdSuite) TestConjured() {
	...
	testCase := []struct {
		...
		{
			Desc:         "Case 4 Conjured sellIn 5 quality extra 2",
			numberOfDays: 15,
			items: []*gildedrose.Item{
				{"Conjured", 5, 10},
			},
		...
		{
			Desc:         "Case 5 Conjured sellIn 2 quality extra -1",
			numberOfDays: 7,
			items: []*gildedrose.Item{
				{"Conjured", 2, -1},
			},
		...
		{
			Desc:         "Case 6 Conjured sellIn 20 quality 10",
			numberOfDays: 6,
			items: []*gildedrose.Item{
				{"Conjured", 20, 10},
			},
		...
		{
			Desc:         "Case 7 Conjured sellIn 20 quality 20",
			numberOfDays: 6,
			items: []*gildedrose.Item{
				{"Conjured", 20, 20},
			},
