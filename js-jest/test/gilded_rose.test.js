...
describe("Conjured Item", function() {
  it("before sell date", function() {
    const gildedRose = new Shop([new Item("conjured cake", 5, 10)]);
    const items = gildedRose.updateQuality();
    expect(items[0].sellIn).toBe(4);
    expect(items[0].quality).toBe(8);
  });
  ...
  it("on sell date", function() {
    const gildedRose = new Shop([new Item("conjured cake", 0, 10)]);
    const items = gildedRose.updateQuality();
    expect(items[0].sellIn).toBe(-1);
  ...
  it("with a quality of 0", function() {
    const gildedRose = new Shop([new Item("conjured cake", 5, 0)]);
    const items = gildedRose.updateQuality();
    expect(items[0].sellIn).toBe(4);
    expect(items[0].quality).toBe(0);
  });
