...
class GildedRoseTest extends TestCase
{
    ...
    public function testUpdateConjuredBeforeSellDate(): void
    {
        // arrange
    ...
    public function testUpdateConjuredOnSellDate(): void
    {
        // arrange
        $items = [new Item('normal', 0, 10)];
        $app = new GildedRose($items);
    ...
    public function testUpdateConjuredAfterSellDate(): void
    {
        // arrange
        $items = [new Item('normal', -5, 10)];
        $app = new GildedRose($items);
    ...
    public function testUpdateConjuredWithAQualityOf0(): void
    {
        // arrange
        $items = [new Item('normal', 5, 0)];
        $app = new GildedRose($items);
