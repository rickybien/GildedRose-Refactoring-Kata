        ...
        public void UpdateQuality()
        {
            for (var i = 0; i < Items.Count; i++)
            {
                if (Items[i].Name != "Aged Brie" && Items[i].Name != "Backstage passes to a TAFKAL80ETC concert")
                {
                    ...
                    {
                        Items[i].Quality = Items[i].Name == "Conjured Mana Cake" ? Items[i].Quality -= 2 : Items[i].Quality -= 1;
                    }
                }
                else
                {
                    if (Items[i].Quality < 50)
                    {
                        ...
                        {
                            if (Items[i].SellIn < 11 && Items[i].Quality < 50) Items[i].Quality += 1;
                            if (Items[i].SellIn < 6 && Items[i].Quality < 50) Items[i].Quality += 1;
                        }
                    }
                }
